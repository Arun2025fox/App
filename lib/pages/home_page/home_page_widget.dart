              ...
              child: Column(
                ...
                children: [
                  ...
                  if (responsiveVisibility(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(58.0, 25.0, 58.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Expanded(
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(60.0, 20.0, 60.0, 0.0),
                      child: SingleChildScrollView(
                        scrollDirection: Axis.horizontal,
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                                  ...
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.itemcardsModel1,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel2,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel3,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel4,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel5,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel6,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel7,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel8,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel9,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel10,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel11,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel12,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel13,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel14,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel15,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.itemcardsModel16,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: ItemcardsWidget(),
                                          ),
